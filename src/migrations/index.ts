...
import * as migration_20260126_add_versioned_posts_template_tables from './20260126_add_versioned_posts_template_tables';
import * as migration_20260126_add_tenant_ovr_versioned_table from './20260126_add_tenant_ovr_versioned_table';
...
export const migrations = [
  ...
  {
    up: migration_20260126_add_versioned_posts_template_tables.up,
    down: migration_20260126_add_versioned_posts_template_tables.down,
    name: '20260126_add_versioned_posts_template_tables'
  },
  {
    up: migration_20260126_add_tenant_ovr_versioned_table.up,
    down: migration_20260126_add_tenant_ovr_versioned_table.down,
    name: '20260126_add_tenant_ovr_versioned_table'
  },
];
